...
func (r mongoRepository) Find(code string) (*shortener.Redirect, error) {
	...
	if err != nil {
		if err == mongo.ErrNoDocuments {
			return nil, errors.Wrap(shortener.ErrRedirecNotFound, "repository.NotFound")
		}
...
func NewRepository(mongoURL, mongoDB string, mongoTimeout int) (shortener.RedirectRepository, error) {
